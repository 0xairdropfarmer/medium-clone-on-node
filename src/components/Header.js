        ...
        <div className="container-fluid col-md-10 col-md-offset-1">
            ...
            <div className="folding-nav">
                <ul className="nav navbar-nav navbar-right">
                    <li className="new-post-button"><a className="button" data-behavior="trigger-overlay" href="#">Write a story</a></li>
                    <li onClick={this.openSignInWith} className="sign-in-button"><a className="button green-border-button" data-behavior="trigger-overlay" href="#">Sign in / Sign up</a></li>
                </ul>
            </div>
